...
wcześniej podpisu cyfrowego ECDSA dla danej wiadomości. Opis poszczególnych komórek z kodem wraz z instrukcją obsługi aplikacji znajduje się w załączonej _dokumentacji technicznej_.

Aplikacja została napisana w języku Python. Możliwe jest lokalne uruchomienie pliku .ipynb (np. w Visual Studio Code) lub skorzystanie z gotowego środowiska w Google Colab:
https://colab.research.google.com/drive/1ejEHBW-zGegK1m_o5msvTpjDvnJtPYS4?usp=sharing
